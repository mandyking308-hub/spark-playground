...
import { Clock3, Globe2, Lightbulb, Plus, School, Trophy } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap justify-end gap-2">
        <Button variant="outline" asChild>
          <Link to="/dashboard/challenge-builder">
            <Plus className="mr-2 size-4" /> Staff: create challenge
          </Link>
        </Button>
      </div>
          ...
          <Card key={challenge.title}>
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full" asChild>
                <Link to="/dashboard/challenge-submit">View & submit</Link>
              </Button>
            </CardContent>
          </Card>
        ))}
      ...
      <Card>
        ...
        <CardContent><Badge variant="secondary">Project first · identity minimised · no judge DM</Badge></CardContent>
      </Card>
    </div>
  );
}
