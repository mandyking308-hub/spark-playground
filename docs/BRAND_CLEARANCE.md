...
- An active UK company named **AURELIA LIMITED** (company no. 03809230) is registered at Companies House and lists SIC **85320 — Technical and vocational secondary education**.
- A registered UK **AURELIA** trade mark exists in Class 41 among other classes (Carnival UK Ltd; cruise-related education/entertainment services).
- A US federal **AURELIA** application filed in 2026 covers Class 41 educational services and an online community platform.
...
Observed as already registered/owned as of the sweep:

- `aurelia.com` — owned and offered for sale.
- `aurelia.co.uk` — registered; domain history dates to 2005.
- `aurelia.ai` — occupied.
- `aurelia.world` — registered/parked/aftermarket nameservers observed.
...
At minimum, counsel should assess the intended specification across likely Nice classes including:

- Class 9 — downloadable software/apps where relevant.
- Class 41 — education, training, entertainment, clubs/challenges and learning services.
- Class 42 — SaaS/PaaS, AI/software services and hosting.
- Potentially Class 35 — community/business/partner programme administration where appropriate.

The exact specification should be drafted by qualified trademark counsel rather than copied from another filing.
